...
public:
  ...
  // Http::Stream  
  //  callbacks === ConnPoolImpl::StreamWrapper
...
//  网络层的连接  代码在E:\envoy-master\source\common\event\dispatcher_impl.cc
...
private:
  ...
  struct ActiveRequest {
    ...
    ResponseStreamEncoderImpl response_encoder_;//ServerConnectionImpl ==E:\envoy-master\source\common\http\http1\codec_impl.cc
 ...
 */
//  ConnectionImpl 实现 http setting的回调
