...
// E:\envoy-master\source\server\connection_handler_impl.cc   connectionHandler中调用它创建连接
//来自 downstream的 连接
...
DispatcherImpl::createListener(Network::Socket& socket, Network::ListenerCallbacks& cb,
  ...
  ASSERT(isThreadSafe());
  // // ConnectionHandlerImpl::ActiveListener 作为cb 
  //  ListenerImpl  在E:\envoy-master\source\common\network\listener_impl.cc
