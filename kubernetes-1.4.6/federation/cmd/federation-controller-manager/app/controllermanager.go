...
func StartControllers(s *options.CMServer, restClientCfg *restclient.Config) error {
	...
	//  F:\go-source\kubernetes-1.4.6\federation\pkg\federation-controller\cluster\clustercontroller.go
	// 处理集群事件 list watch 然后addCluster
	go clustercontroller.NewclusterController(ccClientset, s.ClusterMonitorPeriod.Duration).Run()
	//DNS域名服务器 F:\go-source\kubernetes-1.4.6\federation\pkg\dnsprovider\plugins.go 插件形式
...
//命名空间服务
	...
	// F:\go-source\kubernetes-1.4.6\federation\pkg\federation-controller\namespace\namespace_controller.go
