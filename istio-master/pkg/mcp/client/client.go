...
// mixer 的backend 生成MCP  client
//F:\go-source\istio-master\mixer\pkg\config\mcp\backend.go
...
//F:\go-source\istio-master\mixer\pkg\config\mcp\backend.go   mixer中启动
func (c *Client) Run(ctx context.Context) {
	...
	for {
		...
		for {
			...
			var err error
			//F:\go-source\istio-master\mixer\pkg\config\mcp\backend.go 中有库函数定义 client
