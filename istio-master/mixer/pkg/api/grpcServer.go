...
func NewGRPCServer(dispatcher dispatcher.Dispatcher, gp *pool.GoroutinePool, cache *checkcache.Cache) mixerpb.MixerServer {
	...
	return &grpcServer{
		dispatcher:     dispatcher,//  F:\go-source\istio-master\mixer\pkg\runtime\dispatcher\dispatcher.go
		gp:             gp,
		globalWordList: list,
...
//F:\go-source\istio-master\mixer\pkg\runtime\dispatcher\reporter.go
//同级目录下
