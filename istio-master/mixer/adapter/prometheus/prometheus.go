...
func (b *builder) clearState() {
	//F:\go-source\istio-master\vendor\github.com\prometheus\client_golang\prometheus\registry.go
...
// 启动 http server 接受metics  F:\go-source\istio-master\vendor\github.com\prometheus\client_golang\prometheus\promhttp\http.go
