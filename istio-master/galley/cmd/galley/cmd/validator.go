...
func createMixerValidator() (store.BackendValidator, error) {
	...
	// F:\go-source\istio-master\mixer\pkg\config\store\validator.go 
...
func validatorCmd(printf, fatalf shared.FormatFn) *cobra.Command {
	...
	validatorCmd := &cobra.Command{
		...
		Run: func(_ *cobra.Command, args []string) {
			...
			//F:\go-source\istio-master\galley\pkg\crd\validation\webhook.go
			//   启动了个http server
